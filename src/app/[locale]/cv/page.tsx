  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="mt-6 px-4 py-2 border-2 border-[var(--color-foreground)] text-[var(--color-foreground)] font-semibold rounded-none cursor-pointer hover:bg-[var(--color-foreground)] hover:text-white print:hidden"
      >
        Skriv ut / Spara
      </button>
    </main>
